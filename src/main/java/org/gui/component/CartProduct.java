...
public class CartProduct extends javax.swing.JPanel {
     ...
     * @param lProduct
     */
    public CartProduct(Product lProduct) {
        gProduct = lProduct;
        initComponents();
        loadProductData();
        setupStyle();
    ...
    private void setupStyle() {
        ...
        jPanel1.setBorder(BorderFactory.createLineBorder(new Color(240, 240, 240), 1, true));
        ...
        jLabel5.setFont(new java.awt.Font("Segoe UI", 0, 11));
        jLabel5.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jLabel5.setOpaque(true);
        jLabel5.setBorder(BorderFactory.createEmptyBorder(2, 4, 2, 4));
